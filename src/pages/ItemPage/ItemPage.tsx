...
export const ItemPage: React.FC = () => {
  ...
  useEffect(() => {
    getCurrPhone(itemId as string).then(phone => setCurrPhoneAllSpecs(phone));
    getPhones().then(phones => {
      setCurrPhone(phones.find((phone: Phone) => phone.id === itemId));
          ...
          <div className="grid itemPage__section">
            ...
            >
              <img
                ...
                src={`${BASE_URL}/${currPhoneAllSpecs.images[activeImgId.currVal]}`}
                alt="selected"
              />
            </div>
